const hologram4dsComponent = () => ({
  ...
  init() {
    ...
    this.data['audio-4ds'] = require('./../../assets/hologram/guide.mp3')
    ...
    const removeHolo = () => {
      if (this.model4DS.isPlaying) {
        this.model4DS.pause()  // pause
      }
    }
    // this.pauseBtn.addEventListener('click', pauseHolo)
    this.pauseBtn.addEventListener('click', removeHolo)
